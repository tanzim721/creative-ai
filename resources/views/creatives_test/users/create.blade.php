...
@section('title', 'Toucan Creative - User Create')
@section('meta-description', 'Toucan Creative - User Create') 
                ...
                <div class="max-w-4xl mx-auto">
                    ...
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                        <div class="bg-gradient-to-r from-blue-600 to-indigo-700 px-6 py-4 flex justify-between items-center">
                            <h1 class="text-sm font-bold text-white">{{ __('Create New user') }}</h1>
                ...
                <div class="flex items-center justify-center min-h-screen bg-gray-50">
                    <div class="bg-white p-8 rounded-lg shadow-md">
                        <div class="text-center">
                            ...
                            <h2 class="text-sm font-bold text-gray-800 mt-4">Access Denied</h2>
