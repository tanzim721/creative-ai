...
<body>
    ...
    <div class="gradient_bg w-full min-h-screen flex flex-col items-center py-20">
        ...
        <iframe src="https://d2v3eqx6ppywls.cloudfront.net/toucan_games/basketball/index.html" id="gameIframe" frameborder="0"></iframe>
        <a>
            <img src="{{ asset('uploads/' . $images[0]) }}" class="d-none" />
        </a>
    ...
    let pageContent = document.documentElement.outerHTML;
        ...
        document.querySelector("#click").classList.add("d-none");
        const iframe = document.getElementById("gameIframe");
        iframe.contentWindow.postMessage(
          { action: "playGame" },
          "https://127.0.0.1:8000/basketball_v2/"
        );
        setTimeout(() => {
          iframe.src = "";
      ...
      document
        ...
        .addEventListener("click", sendMessageToIframe);
